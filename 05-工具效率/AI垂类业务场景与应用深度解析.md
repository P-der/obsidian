...
> [!warning] 勘误 / 口径提示
> 原稿引用的\"点击率 +171%\"、\"单款节省 800 元\"均为厂商案例口径。
...
> [!warning] 勘误 / 口径提示
> 原稿\"可灵 30 秒 / Seedance 12 秒 / HappyHorse 150B / Sora 分钟级 4K\"已修正；`happyhorseprompt.com` **非官方**。
...
> [!warning] 勘误 / 口径提示
> 勘误：ElevenLabs **70+** 语言（非 30+）；Fish Audio 8000 **credits**（非字符）；ChatTTS 商用需授权；冬瓜\"99.8% 还原 / 700+ 音色\"为第三方测评，非官网数字。
...
> [!warning] 勘误 / 口径提示
> 原稿\"完听率 85% / 周均 42 小时\"未在公开资料核实到，按厂商口径对待。
...
> [!warning] 勘误 / 口径提示
> 原稿\"Copilot 85% confidence\"为对 95% 置信区间的误读。
